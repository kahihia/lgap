...
public class ProductServiceVertxProxyHandler extends ProxyHandler {
  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        case "getProductById": {
          service.getProductById(json.getValue("id") == null ? null : (json.getLong("id").longValue()), res -> {
            if (res.failed()) {
        ...
        case "saveProduct": {
          service.saveProduct(json.getJsonObject("product") == null ? null : new edu.lenzing.lgap.microservice.product.model.Product(json.getJsonObject("product")), res -> {
            if (res.failed()) {
              if (res.cause() instanceof ServiceException) {
                msg.reply(res.cause());
              } else {
